...
## AI Service > Speech to Text > 콘솔 사용 가이드 { #ai-service-speech-to-text-console-user-guide }
...
<a id="input-speech-for-text-conversion"></a>
### 텍스트 변환을 위한 음성 입력 { #input-speech-for-text-conversion }
