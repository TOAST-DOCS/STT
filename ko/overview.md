...
## AI Service > Speech to Text > 개요 { #ai-service-speech-to-text-overview }
...
### 동기(Synchronous) API { #synchronous-api }

* 최대 용량: 150MB
* 음성 파일 인식 가능 시간: 최소 0.36초, 최대 3,600초
* 짧은 길이의 음성에 대해 빠른 응답이 필요한 경우에 적합합니다.

<a id="asynchronous-api"></a>
### 비동기(Asynchronous) API { #asynchronous-api }
